...
public abstract partial class SharedPlanetSystem : EntitySystem
{
    [Dependency] protected readonly IConfigurationManager CfgManager = default!;
    [Dependency] private readonly IPrototypeManager _proto = default!;

    /// <summary>
    /// Main loot table for salvage expeditions, placeholder for planets too for now
    /// </summary>
    ...
    public Planet GetPlanet(SalvageDifficultyPrototype difficulty, int seed)
    {
        ...
        return new Planet(seed, dungeon.ID, faction.ID, biome.ID, air.ID, temp.Temperature, light.Color, duration, mods);
    }
